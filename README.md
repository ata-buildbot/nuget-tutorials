# nuget-tutorials
This repository contains NuGet tutorial projects that show typical imaging / capture-oriented applications you may create with [Atalasoft DotImage product](https://www.atalasoft.com/Products/DotImage).
